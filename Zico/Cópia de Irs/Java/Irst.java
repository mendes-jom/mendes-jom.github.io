...
public class Irst extends java.applet.Applet {
...
//	myString = new String("Zico: Cálculo de Irs... ");
  ...
  public void paint (Graphics g) {
   ...
   g.drawString("RL           "+myNR(RL),mm,55);
	   ...
	   g.drawString("IRS-COLECTA  "+myNR(IRS),mm,115);
	   g.drawString("IRS PAGO     "+myNR(IRSPAGO),mm,130);
	

   g.drawString("DAC99        "+myNR(DAC99),mm,145);
   g.drawString("DAC80        "+myNR(DAC80),mm,160);



   g.drawString(PAYREC,mm,163+15);
   g.drawRoundRect(1,  1   ,220,171+15 ,7,7);
   g.drawRoundRect(3,  3   ,216, 20    ,7,7);
   g.drawRoundRect(3,150+15,216, 20    ,7,7);
   g.drawRoundRect(3, 25   ,216,123+15    ,7,7);
   g.drawLine(89,25,89,147+15);
  }
//================================
...
// na =        : número de ascendentes..
        ...
        if (ONtest==1) {zeString ="@ José Oliveira Mendes @";}
// Mais vale ter um \n ProgramaZico \nque não ter \nprograma nenhum...";
        int Divisor=100;
        Ano=b; //IndexYear(b)-1;
...
///////////////////////////////////////////////// : 1999
  ...
  if  ( ONtest==1) {      //   "O": Old  "N" New method
	...
	DAC99=DAC99+Math.min(DPPH,(DPPHx[Ano]*(DRC[3]+DRC[4]+DRC[5]+DRC[6])+50)/100);
        DAC99=DAC99+Math.min(DPRI,(DPRIx[Ano]*(DRC[9] +DRC[10]            )+50)/100);
        DAC99=DAC99+Math.min(DBES,(DBESx[Ano]*(DRC[11]+DRC[12]            )+50)/100);
...
//  REVER:::: 3ºFilho+++ e se Pensao?? // 55-c) dependentes
		...
		z8p=Math.min(DLimDiv+DEduca ,z8+ABAT1[8]         // 55-c)Desp c/Educação -Sj Pass A
					     +DiscEducDep      // 55-c) dependentes
			      )-z8;    
//	        DAC99=DAC99+z8+z8p;
			// 1999 Falta corrigir Com pensões Lares certos casos        
	DAC99=DAC99+Math.min(DEduca ,(DEducax[Ano]   *(ABAT1[8]                 )+50)/100);            
...
public int[]    M3      ={6000000 ,6150000 ,6280000 ,2560000};
...
public int[]   DPPRx    ={0 , 0 , 0 ,     5};//0.05 : 5% do RB

public int[]    PPH1    ={400000  , 410000 , 418000 ,426360};
public int[]    PPH2    ={400000  , 410000 , 418000 ,426360};
...
public int[]   DPRIx    ={0  , 0 , 0 , 5};//0.05 : 5%
public int[]   DBES1    ={0  , 0 , 0 ,49000};// Max Start 1999
public int[]   DBES2    ={0  , 0 , 0 ,98000};// Max Start 1999
public int[]   DBESx    ={0  , 0 , 0 , 5};//0.05 : 5%
public int[]   DPPA1    ={0  , 0 , 0 ,49000};// Max Start 1999
public int[]   DPPA2    ={0  , 0 , 0 ,98000};// Max Start 1999
...
public int[]    DAC80_1 ={33000    ,34500    ,  35200  ,35904};
public int[]    DAC80_2 ={25000*2  ,26300*2  ,  26800*2,27336*2};
public int[]    DAC80_AX={    0    ,19000    ,  19400  ,19788};
public int[]    DAC80_F1={ 18000   ,19000    ,  19400  ,19788};
public int[]    DAC80_F2={  +200   ,     +210,   +220  , +224};
public int[]    DAC80_F3={  +400   ,     +430,   +440  ,+449};
public int[]    DAC80_FX={  +500   ,     +550,   +560  ,+571};
//COMPUTADORES:(1998-2001)
...
///////////////////////////////////// 1999 ///////////////////
public int[]   DSaudex   ={0  , 0 , 0 ,25};// 1999
...
public int[]   DEduca1   ={0  , 0 , 0 ,42300};// 1999
public int[]   DEduca2   ={0  , 0 , 0 ,84600};// 1999
public int[]   DEducax   ={0  , 0 , 0 ,25};// 1999
...
public int[]   DLimJuros ={0  , 0 , 0 ,78600};//1999
public int[]   DLimJurosx={0  , 0 , 0 ,25};//1999
