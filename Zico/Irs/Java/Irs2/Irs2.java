...
public class Irs2 extends java.applet.Applet {
  String   myString,zeString,PAYREC;
  int      IRS,DAC80,NOFIM,Zico,RL,IRSPAGO,DRC55,ART55,COLECTAVEL,RB,MPS_PDR ;
  int[][]  XXX      =new int[10][25];
...
int[] BaseQuots=new int[6] ;;
       int j;for ( j=1 ;j<=21 ; j=j+1)    {ABAT1[j]=XXX[1][j];
		...
		RL     =RL     +RBA[j]+RBH[j]+XXX[6][j]-XXX[5][j];
		RB     =RB     +RBA[j];
                IRSPAGO=IRSPAGO+XXX[4][j]+XXX[8][j];          
...
//COMPUTADORES:(1998-2001)
	DAC80=DAC80+Math.min(ABAT1[18] *COMPx[Ano],COMP[Ano]);

//ACONSELHAMENTO JURÍDICO:(1998..)
	DAC80=DAC80+Math.min(ABAT1[19] *JURIx[Ano],JURI[Ano]);
...
///////////////////////////////////////////////////////////////////////
public String[] Anos    ={ "1996" , "1997" ,"1998"};
public int[]    Divisor1={   100  ,    100 ,  100 };// 95%=0.95
public int[]    Divisor2={   195  ,    200 ,  200 };//195%=1.95

public int[]    M0      ={0       ,      0 ,    0 };
public int[]    M1      ={1010000 ,1050000 ,1080000 };
public int[]    M2      ={2350000 ,2435000 ,2500000 };
public int[]    M3      ={6000000 ,6150000 ,6280000 };
public int[]    T1      ={15      ,     15 ,     15 };// %
public int[]    T2      ={25      ,     25 ,     25 };// %
public int[]    T3      ={35      ,     35 ,     35 };// % 
public int[]    T4      ={40      ,     40 ,     40 };// %
...
public int[]    LimDiv1 ={159000  , 163000 , 166000 };
public int[]    LimDiv2 ={319000  , 327000 , 332000 };
...
public int[]    EducaN  ={                0, 20000  //(1997.. a mais pelo 3º,4º,.. filho
				           , 35000};
//--Energia renovável:
public int[]    Renova1 ={262000-LimDiv1[0],30000  ,10000};
public int[]    Renova2 ={422000-LimDiv1[0],60000  ,10000};
public int[]    Renovax ={100              ,100    ,20   };// %
//-- Prémios seg de vida: (Sim: 1998= 1997)
public int[]    Seguro1 ={35000   , 36000  ,  36000 };
public int[]    Seguro2 ={70000   , 72000  ,  72000 };
//--Donativos (1998 parece ter mudado --- Verificar se 110% e se igual para ambos)
public int[]    Donat1  ={15      ,     15 ,     15 };// 0.15:15%
public int[]    Donat2  ={30      ,     30 ,     15 };// 0.30:30%
public int[]    Donatx  ={110     ,    110 ,    110 };// 1.1 :110%
//Aquisição ou construção sem crédito..
public int[]    Const1  ={297000  , 305000 , 305000 };
public int[]    Const2  ={297000  , 305000 , 305000 };
public int[]    Constx  ={10      ,     10 ,     10 };// 0.1 : 10%
// RENDAS
public int[]    Rendas  ={0       , 500000 , 500000 };// Novo 1997
...
public int[]    LimJuros={297000  , 305000 , 308000 };
// Quotizações sindicais, acrescidas de 50%
public int[]    QuotAx   ={1       ,      1 ,      1 };// 0.01:  1%
public int[]    QuotHx   ={0       ,      1 ,      1 };// 0.01:  1%


/////////==============================================DRC55 < DRC[]

public int[]    PPR1    ={400000  , 410000 , 418000 };
public int[]    PPR2    ={800000  , 820000 , 836000 };
public int[]    PPRx    ={    20  ,     20 ,     20 };//0.2 : 20%

public int[]    PPH1    ={400000  , 410000 , 418000 };
public int[]    PPH2    ={400000  , 410000 , 418000 };

public int[]    OPC1    ={0       ,      0 ,      0 }; ///??
public int[]    OPC2    ={0       ,      0 ,      0 }; ///??
// Privatizações:
public int[]    PRI1    ={130000  , 130000 , 130000 };
public int[]    PRI2    ={261000  , 261000 , 261000 };
public int[]    PRIx    ={    20  ,     20 ,     20 };//0.2 : 20%
public int[]    BES1    ={196000  , 196000 , 196000 };
public int[]    BES2    ={391000  , 391000 , 391000 };
public int[]    BESx    ={0       ,     30 ,     30 };//0.3 : 30%

public int[]    FIM1    ={0       ,      0 ,      0 };//Só 1992 e 1994...
public int[]    FIM2    ={0       ,      0 ,      0 };//Só 1992 e 1994...

public int[]    PPA1    ={150000  , 150000 , 150000 };
public int[]    PPA2    ={300000  , 300000 , 300000 };
public int[]    PPAx    ={    30  ,     30 ,     30 };//0.3 : 30%
// Conta Poupança Condomínio : 1 % do valor matricial com limite de: (1998=1997)
public int[]    CON1    ={ 26000  ,  27000 ,  27000 };
public int[]    CON2    ={ 26000  ,  27000 ,  27000 };
// DEDUÇÕES À COLECTA:(ARTº.80.º DO CIRS)
// PESSOAS E FAMILIARES:
public int[]    DAC80_1 ={33000    ,34500    ,  35200  };
public int[]    DAC80_2 ={25000*2  ,26300*2  ,  26800*2};
public int[]    DAC80_AX={    0    ,19000    ,  19400  };
public int[]    DAC80_F1={ 18000   ,19000    ,  19400  };
public int[]    DAC80_F2={  +200   ,     +210,   +220  };
public int[]    DAC80_F3={  +400   ,     +430,   +440  };
public int[]    DAC80_FX={  +500   ,     +550,   +560  };
//COMPUTADORES:(1998-2001)
public int[]    COMP    ={ 0  , 0 , 30000 };
public int[]    COMPx   ={ 0  , 0 ,    20 };//%
//ACONSELHAMENTO JURÍDICO:(1998..)
public int[]    JURI    ={ 0  , 0 , 20000 };
public int[]    JURIx   ={ 0  , 0 ,    20 };//%
//energias renováveis:   :(1998,...) ver acima Renova1 Renova2 Renovax
