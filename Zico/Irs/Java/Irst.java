...
//        DAC99=DAC99+Math.min(DPPR,Math.min(RB*DPPRx[Ano]/100,DRC[1]+DRC[2]));
	...
	DAC99=DAC99+Math.min(DPPH,(DPPHx[Ano]*(DRC[3]+DRC[4]+DRC[5]+DRC[6])+50)/100);
        ...
        DAC99=DAC99+Math.min(DBES,(DBESx[Ano]*(DRC[11]+DRC[12]            )+50)/1000);
...
//	        DAC99=DAC99+z8+z8p;
	...
	DAC99=DAC99+Math.min(DEduca ,(DEducax[Ano]   *(ABAT1[9]                 )+50)/100);            
// ABAT1[8] => ABAT1[9] em 27/04/99
...
public int[]   DPPR1    ={0 , 0 , 0 ,105000};// Max Start 1999
public int[]   DPPR2    ={0 , 0 , 0 ,210000};// Max Start 1999
public int[]   DPPRx    ={0 , 0 , 0 ,     25};//0.05 : 25% das entregas
...
public int[]   DBESx    ={0  , 0 , 0 , 75};//0.05 : 5%
